...
channel.wsend({ embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(lewyim.GuildID).name, iconURL: client.guilds.cache.get(lewyim.GuildID).iconURL({dynamic:true})}).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
...
channel.wsend({ embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(lewyim.GuildID).name, iconURL: client.guilds.cache.get(lewyim.GuildID).iconURL({dynamic:true})}).setThumbnail(oldState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
...
channel2.wsend({ embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(lewyim.GuildID).name, iconURL: client.guilds.cache.get(lewyim.GuildID).iconURL({dynamic:true})}).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
