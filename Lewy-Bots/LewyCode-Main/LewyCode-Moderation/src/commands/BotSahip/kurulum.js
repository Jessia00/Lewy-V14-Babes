...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    } else if (!lewyim.owners.includes(message.author.id)) {
      ...
      collector.on("collect", async interaction => {
        ...
        if (interaction.customId === "emoji") {
          ...
          const emojis = [
              ...
              { name: "lewyspotify", url: "https://cdn.discordapp.com/emojis/899337292840312912.png?size=44" },
              { name: "lewynetflix", url: "https://cdn.discordapp.com/emojis/941993358518284298.webp?size=96&quality=lossless" },
              { name: "lewyexxen", url: "https://cdn.discordapp.com/emojis/900396713116835900.png?size=44" },
              { name: "lewyblutv", url: "https://cdn.discordapp.com/emojis/900396707362246666.png?size=44" },
              { name: "lewynitro", url: "https://cdn.discordapp.com/emojis/941993742934614047.webp?size=96&quality=lossless" },
              { name: "lewyyoutube", url: "https://cdn.discordapp.com/emojis/941993963013935115.gif?size=96&quality=lossless" },
